...
class Scene:
    ...
    def add_game_object(self, game_object):
        """
        Add a new Balance object to the scene's mesh_objects list
    ...
    def find_game_object_by_type(self, type_of_game_obj):
        """
        Return a list with all Balance object in the current scene that
        is instance of the class type_of_game_obj
        :param type_of_game_obj: the name of the class of the Balance object that you wat to find
    ...
    def find_game_object_by_tag(self, tag):
        ...
        :return: a list with the Balance object with that tag
        """
        return_list = []
        for game_object in self.game_objects:
    ...
    def debug_fps(self):
        """
        DEBUG: print the Balance fps each frame
        """
